package fr.polytech.unice.esb.services.flights;

import fr.polytech.unice.esb.services.flights.actions.DocumentAction;
import fr.polytech.unice.esb.services.flights.components.ActionComponent;
import fr.polytech.unice.esb.services.flights.components.ResponseComponent;
import fr.polytech.unice.esb.services.flights.models.errors.ActionNotFound;
import fr.polytech.unice.esb.services.flights.models.errors.InternalServerError;
